...
def get_empty_hist(name, title):
	hist = ROOT.TH1D(name, title, 50, 50, 300)
	return hist
...
#                hist.Fill(H_mass[0],(Vtype[0] == lep_type)*(dEta_jj<1.6)*(dR_jj>0.5)*(dR_jj < 3.2)*weight[0]*(bjet2_PtReg[0]>30)*(bjet2_DeepCSV>0.2)*(bjet1_DeepCSV>0.5)*(lep2_pt < 130)*(lep1_pt > 40)*(ee_m > 87)*(ee_m < 95))
                        hist.Fill(MT2,(dEta_jj<1.6)*(dR_jj>0.5)*(dR_jj < 3.2)*weight[0]*(bjet2_PtReg[0]>30)*(bjet2_DeepCSV>0.2)*(bjet1_DeepCSV>0.5)*(lep2_pt < 130)*(lep1_pt > 40))
                else:
                        hist.Fill(MT2,(Vtype[0] == lep_type)*(dEta_jj<1.6)*(dR_jj>0.5)*(dR_jj < 3.2)*weight[0]*(bjet2_PtReg[0]>30)*(bjet2_DeepCSV>0.2)*(bjet1_DeepCSV>0.5)*(lep2_pt < 130)*(lep1_pt > 40))  
